...
public class staff_CheckIn {
	...
	public staff_CheckIn() {
		initialize();
	}

	public void staff_CheckIn_setVisible() {
	...
	private void initialize() {
		...
		frame = new JFrame();
		frame.setTitle("Check In Report for Staff");
		frame.setResizable(false);
		frame.setBounds(100, 100, 700, 450);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.getContentPane().setLayout(null);
		
		lbl_title = new JLabel("Students Check In Report");
		...
		try {
			file = new File("students_check_in_list.txt");
