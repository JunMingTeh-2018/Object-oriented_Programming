...
public class eKewangan_Unpaid {
	private controller controller;
	private student currentStudent;
	private JFrame frame;
	private JLabel lbl_title, lbl_total, lbl_facility, lbl_ict_utility_service, lbl_management, lbl_library;
	private JPanel panel;
	private JButton btn_make_payment, btn_back;
	
	public eKewangan_Unpaid(student student) {
		currentStudent = student;
		initialize();
	}

	public void eKewangan_Unpaid_setVisible() {
	...
	private void initialize() {
		...
		frame = new JFrame();
		frame.setTitle("eKewangan Unpaid Payment Details");
		...
		lbl_title = new JLabel("Student Fees for Semester 2019/2020");
		...
		lbl_total.setBounds(10, 66, 476, 31);
		frame.getContentPane().add(lbl_total);
		
		panel = new JPanel();
		panel.setBounds(32, 107, 432, 241);
		...
		lbl_facility.setBounds(20, 20, 388, 43);
		...
		lbl_ict_utility_service.setBounds(20, 73, 388, 43);
		panel.add(lbl_ict_utility_service);
		
		lbl_management = new JLabel("<html>&nbsp;Management Fees<br>&nbsp;Total  :  RM 100.00</span></html>");
		lbl_management.setFont(new Font("Microsoft Sans Serif", Font.PLAIN, 14));
		lbl_management.setOpaque(true);
		lbl_management.setHorizontalAlignment(SwingConstants.LEFT);
		lbl_management.setForeground(Color.BLACK);
		lbl_management.setBorder(new SoftBevelBorder(BevelBorder.LOWERED, null, null, null, null));
		lbl_management.setBackground(new Color(204, 255, 153));
		lbl_management.setBounds(20, 126, 388, 43);
		panel.add(lbl_management);
		...
		lbl_library.setBounds(20, 179, 380, 43);
		panel.add(lbl_library);
		
		btn_make_payment = new JButton("MAKE PAYMENT");
		btn_make_payment.setBounds(115, 358, 259, 38);
		...
		btn_make_payment.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				controller.eKewangan_MakePayment(currentStudent,"Unpaid");
				frame.dispose();
			}
		});
		...
		btn_back.setBounds(192, 406, 104, 31);
